...
class ProductController {
    ...
    @ApiResponses(
        ...
        ApiResponse(responseCode = "400", description = "Product already exists", content = [io.swagger.v3.oas.annotations.media.Content(mediaType = "text/plain")]),
    )
    @PostMapping("/product")
    ...
    @ApiResponses(
        ApiResponse(responseCode = "200", description = "Get all products", content = [io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json", schema = io.swagger.v3.oas.annotations.media.Schema(implementation = Array<Product>::class))]),
    )
    ...
    @ApiResponses(
        ApiResponse(responseCode = "200", description = "Successfully changed availability of product", content = [io.swagger.v3.oas.annotations.media.Content(mediaType = "text/plain")]),
        ApiResponse(responseCode = "400", description = "Product not found", content = [io.swagger.v3.oas.annotations.media.Content(mediaType = "text/plain")]),
    )
